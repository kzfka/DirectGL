		...
		namespace GL
		{
			...
			class Bitmap : public Drawable
			{
				...
				public:
					...
					void draw()
					{getTarget()->DrawBitmap(bitmap, {vertex.x, vertex.y, vertex.x + width, vertex.y + height}, 1, D2D1_BITMAP_INTERPOLATION_MODE::D2D1_BITMAP_INTERPOLATION_MODE_NEAREST_NEIGHBOR, {0, 0, width, height});}
			};
		}
	}
